...
public class ExamSession220224 implements ExamSession {

  private static final String ANSWERS_SHEET_PATH = "/sarisary/answers_22-02-24.csv";
  private static final int STDREF_INDEX_IN_SHEET = 2;
  private static final int GROUP_INDEX_IN_SHEET = 3;
  private static final int GIT_URL_INDEX_IN_SHEET = 4;
  private static final int PREPROD_HEALTH_DB_URL_INDEX_IN_SHEET = 5;
  private static final int PREPROD_HEALTH_BUCKET_URL_INDEX_IN_SHEET = 6;
  private static final int PREPROD_API_URL_INDEX_IN_SHEET = 7;
  private static final int PROD_API_URL_INDEX_IN_SHEET = 8;

  public static final Map<String/*stdRef*/, Map<String/*question*/, Integer>> SCORE_PER_STUDENT = new HashMap<>();

  @Override
  public String name() {
    return "PROG3 / PROG5P1 (Sarisary) - Session du 22 février 2024";
  }
  ...
  public StdAnswers toStdAnswers(String line) {
    ...
    return new StdAnswers220224(
        infallibleSupply(() -> asArray[STDREF_INDEX_IN_SHEET].trim()),
        infallibleSupply(() -> asArray[GROUP_INDEX_IN_SHEET].trim()),
        ...
        noEndingSlash(infallibleSupply(() -> asArray[PROD_API_URL_INDEX_IN_SHEET].trim()))
    );
  }
